...
```yaml
name: Aryan Gupta
role: Java Full Stack Developer @ Barrownz Pearl Web Pvt. Ltd.
focus: Building scalable web apps end-to-end
currently_building: RojgarShine — a full-stack job portal platform
recently_shipped: Chess NYC — pixel-perfect static site conversion
...
### 🎯 [RojgarShine](https://rojgarshine.com)
Full-stack job portal platform with recruiter dashboards, admin analytics, ATS scoring, and saved-jobs functionality.

`React 19` `Vite` `Tailwind CSS` `Spring Boot` `MySQL`

</td>
<td width="50%">

### ♟️ [Chess NYC](https://chessnyc.netlify.app)
Pixel-perfect conversion of a WordPress chess academy site into a fast static frontend, with custom carousels, dropdown nav, and reusable web components.

`HTML5` `CSS3` `Vanilla JS` `Bootstrap 5`
